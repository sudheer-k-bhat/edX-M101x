describe('Nav Bar', function(){
	...
	it('shows logged in user\'s name', function(done){
		httpBackend.whenGET('/ch4/6.1/template.html').passThrough();
		httpBackend.expectGET('/api/v1/me').respond({user: {profile: {username: 'John'}}});
